...
doctl compute domain create sw5.pj1.moja-do.delma.me

# 2. Add NS delegation in the parent zone
doctl compute domain records create moja-do.delma.me --record-type NS --record-name sw5.pj1 --record-data ns1.digitalocean.com. --record-ttl 300
doctl compute domain records create moja-do.delma.me --record-type NS --record-name sw5.pj1 --record-data ns2.digitalocean.com. --record-ttl 300
doctl compute domain records create moja-do.delma.me --record-type NS --record-name sw5.pj1 --record-data ns3.digitalocean.com. --record-ttl 300
