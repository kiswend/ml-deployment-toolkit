...
doctl compute domain create sw3.pj1.moja-do.example.com

# 2. Add NS delegation in the parent zone
doctl compute domain records create moja-do.example.com --record-type NS --record-name sw3.pj1 --record-data ns1.digitalocean.com. --record-ttl 300
doctl compute domain records create moja-do.example.com --record-type NS --record-name sw3.pj1 --record-data ns2.digitalocean.com. --record-ttl 300
doctl compute domain records create moja-do.example.com --record-type NS --record-name sw3.pj1 --record-data ns3.digitalocean.com. --record-ttl 300
```